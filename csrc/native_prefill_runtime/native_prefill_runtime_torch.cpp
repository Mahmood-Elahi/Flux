...
TORCH_LIBRARY_FRAGMENT(flux, library) {
    library.class_<flux::NativeSmolLM2Prefill>("NativeSmolLM2Prefill")
        ...
        .def("generate_greedy", &flux::NativeSmolLM2Prefill::generate_greedy)
        .def("logits", &flux::NativeSmolLM2Prefill::logits)
        .def("current_token", &flux::NativeSmolLM2Prefill::current_token)
        .def("generated_tokens", &flux::NativeSmolLM2Prefill::generated_tokens)
        .def("device_generation_step", &flux::NativeSmolLM2Prefill::device_generation_step)
        ...
        .def("generation_step", &flux::NativeSmolLM2Prefill::generation_step)
