"""Compare the standalone C++ RMSNorm with the Flux PyTorch oracle."""
...
def main() -> int:
    ...
    parser.add_argument("executable", type=Path, help="path to rmsnorm_cli.exe")
    ...
    with tempfile.TemporaryDirectory(prefix="flux-rmsnorm-") as temp_directory:
    ...
    print("C++ RMSNorm matches the PyTorch oracle within FP32 tolerances.")
    return 0
